...
%% Implementation
function pmask_get_consensus_suyeonpmask_test(output_file, p_thresh, k_folds, param, scan_type_num)
...
% pmask_test = get_consensus_mask(cpm_output.pmask_struct.(scan_type),k_folds,trial_count,thresholder);
