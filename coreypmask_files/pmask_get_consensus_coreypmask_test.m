...
% 
% 
% % [pos_mat,neg_mask,pos_mat_size,neg_mat_size] = get_consensus_mask_Suyeon_version(pmask_stock,1,0.05)
% get_consensus_mask_Suyeon_version(pmask_stock,1,0.05)

%% testing with corey's pmasks

load('pmask_for_suyeon.mat')

[pos_mat,neg_mat,pos_mat_size,neg_mat_size] = get_consensus_mask_coreypmask(pmask,1,0.05);
...
% saveas(gcf,'pos_neg_mask_network_representation_raw_edges_coreypmask_test.png')
...
% saveas(gcf,'pos_neg_mask_network_representation_raw_edges_normalized_coreypmask_test.png')
...
% saveas(gcf,'matrix_visualization_mat_1_1_CPM_coreypmask.jpg')
